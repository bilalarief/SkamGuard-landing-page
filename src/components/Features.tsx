        ...
        <div className="grid lg:grid-cols-12 gap-5">
          ...
          <div className="bg-white rounded-2xl p-8 lg:col-span-5 flex flex-col h-full">
            ...
            <div className="bg-[#F3F5F8] rounded-xl p-6 flex items-center justify-center mt-auto min-h-[220px]">
              <img src={features1} alt={t("features.f1_title")} className="max-w-full h-auto object-contain" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 lg:col-span-7 flex flex-col h-full">
            ...
            <div className="bg-[#F3F5F8] rounded-xl p-6 flex items-center justify-center mt-auto min-h-[220px]">
              <img src={features2} alt={t("features.f2_title")} className="max-w-full h-auto object-contain" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 lg:col-span-7 flex flex-col h-full">
            ...
            <div className="bg-[#F3F5F8] rounded-xl p-6 flex items-center justify-center mt-auto min-h-[220px]">
              <img src={features3} alt={t("features.f3_title")} className="max-w-full h-auto object-contain" />
            </div>
          </div>

          {/* Feature 4 - Clear Action Plan (Narrower) */}
          <div className="bg-white rounded-2xl p-8 lg:col-span-5 flex flex-col h-full">
            <h3 className="text-2xl font-semibold text-[#333333] mb-3">
              {t("features.f4_title")}
            </h3>
            ...
            <div className="bg-[#F3F5F8] rounded-xl p-6 flex items-center justify-center mt-auto min-h-[220px]">
              <img src={features4} alt={t("features.f4_title")} className="max-w-full h-auto object-contain" />
            </div>
          </div>
